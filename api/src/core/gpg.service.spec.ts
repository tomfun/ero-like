...
describe('AppController', () => {
  ...
  it('temporaryImportAndVerify should return proper keys 2C8AF92702763EE0 / DSA 1E11B59089A05C6B', async () => {
    const clearSignArmored = {
      ...
      signature1: '1CDB37F335B0637CAE6EDBC2CF1B0500BAE27D5369935AC169BC8DAC1F53CC36',
      signature2: 'AE08349B7E344D5AD242E3534CABBF60E339DA806AC3CF094ECB38F3E2008E73',
    }
    const publicKeyArmored =
    ...
    const key4 = {
      ...
      publicKey1: 'E1A4FC8D47AACC89617E8159466265EDBBD96431B88EDE6FE2A283E89139CC6B',
      publicKey2:
    ...
    expect(
      ...
      publicKeys: [
        ...
        },
        {
          ...
          pkey: [key4.publicKey0, key4.publicKey1, key4.publicKey2, key4.publicKey3],
        },
      ],
      revocatedUserKeys: [],
  ...
  it('temporaryImportAndVerify should return proper keys 02C0F331C1E6D84A EDDSA ed25519', async () => {
    const clearSignArmored = {
      ...
      signature1: 'E861A64D1F928FBD07A351807FEF2396F88271FB2C1D6E59C72B9989A5202139',
      signature2: '34624461769A7883F5CF643E02273BC078E56917DE69577E10A894F0D4F4830E',
    }
...
`
    const key1 = {
      ...
      publicKey1: '403BE30D3EF4A821A5CBCD10DEBCD1CA06ECCBF275B83133854EB4EEFAF391E3A9',
      created: 1677963869,
