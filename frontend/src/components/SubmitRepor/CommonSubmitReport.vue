<template>
  ...
  <Message severity="info">If this is the substance you took in the very begining, then choose
    zero.
  </Message>
  <Message severity="info"> Both of the timelines(substance input, reporting) starts with the first
    substance input.
  </Message>
...
export default defineComponent({
  ...
  methods: {
    ...
    setSingleValue(key: keyof ReportDataAlpha1, value: ReportDataAlpha1[keyof ReportDataAlpha1]) {
